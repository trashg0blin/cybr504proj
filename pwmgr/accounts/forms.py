...
class UpdateSettingsForm(forms.ModelForm):
    error_message = {
        ...
        'username_rules': "Username must not contain any special characters aside from space.",
    }
...
class UpdatePasswordForm(forms.ModelForm):
    ...
    error_messages = {
        'wrong_password':'Previus Password you entered in wrong. Please enter a correct password or use forget password.',
        'password_length':'Your password is not strong enough, must be at least 8 characters long.',
        'password_strength':'Your password is not strong enough, must be at least 8 characters long and should have at least 1 block letter and a number.',
    }
